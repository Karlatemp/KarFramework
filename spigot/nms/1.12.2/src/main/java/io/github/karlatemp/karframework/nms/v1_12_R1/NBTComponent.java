...
public class NBTComponent
    ...
    public void setLongArray(String key, long[] value) {
        base.set(key, new NBTTagLongArray(value));
    }
    ...
    public @NotNull long[] getLongArray(String key) {
        final NBTBase base = this.base.get(key);
        if (base instanceof NBTTagLongArray) {
            return NBTLongArray.getValues((NBTTagLongArray) base);
        }
        return new long[0];
    }
    ...
    public @NotNull ITagCompound clone() {
        return new NBTComponent(base.g());
    }
