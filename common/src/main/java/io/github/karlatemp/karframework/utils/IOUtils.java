...
public final class IOUtils {
     ...
     * @throws IOException if an I/O error occurs.
     */
    public static OpenByteArrayOutputStream readFully(InputStream stream) throws IOException {
        try (InputStream is = stream) {
            OpenByteArrayOutputStream result = new OpenByteArrayOutputStream(is.available());
    ...
    public static String readFullyAsString(InputStream stream, Charset charset) throws IOException {
        return readFully(stream).toStr(charset);
    }
